...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print("Usage: Location_validate.py <file>", file=sys.stderr)
        exit(-1)
    ...
    def new_map(x):
        ...
        if x[14] == "":
            return(str(x[14]),"String, " + "Location, " + "NULL")
        else:
            return(str(x[14]),"String, " + "Location, " + "Valid")
    ...
    counts.saveAsTextFile("Location.out")
